...
exports.silenceWarnings = exports.isUpgradeSafe = exports.getErrors = exports.ValidationErrors = exports.assertUpgradeSafe = exports.getUnlinkedBytecode = exports.getStorageLayout = exports.getContractNameAndRunValidation = exports.getContractVersion = exports.validate = exports.withValidationDefaults = void 0;
...
function getContractNameAndRunValidation(validations, version) {
...
function getStorageLayout(validations, version) {
...
function getUnlinkedBytecode(validations, bytecode) {
    var _a;
    const validationLog = Array.isArray(validations) ? validations : [validations];
    for (const validation of validationLog) {
...
function assertUpgradeSafe(validations, version, opts) {
...
function getErrors(validations, version) {
    const [contractName, runValidation] = getContractNameAndRunValidation(validations, version);
    const c = runValidation[contractName];
    return c.errors
...
function isUpgradeSafe(validations, version) {
